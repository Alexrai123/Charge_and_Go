...
class OfflineChargingStationRepository(private val chargingStationDao: ChargingStationDao) : ChargingStationRepository{
    ...
    override fun getChargingStationById(id: Int): Flow<ChargingStation?> = chargingStationDao.getChargingStationById(id)
    override suspend fun deleteChargingStationById(id: Int) = chargingStationDao.deleteChargingStationById(id)
